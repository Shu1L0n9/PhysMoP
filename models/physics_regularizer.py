...
class PhysicsRegularizer(nn.Module):
    ...
    def forward(self, q, query_times, motion_feats_all, dt=1/25):
        ...
        # Concatenate current state (simplified version)
        # In full version, would concatenate [motion_feats, q, q_dot, q_ddot]
        # For now, just use motion_feats as feature vector
        features = motion_feats_flat  # (B*K, feature_dim)
